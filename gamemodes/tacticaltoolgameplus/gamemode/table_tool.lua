...
TOOL_TABLE = 
{
	...
	automatic = true,
	infinite = true,
	upgrades_charge = true,
	v_model = "models/weapons/v_physcannon.mdl",
	w_model = "models/weapons/w_physics.mdl",
...
imagnitude = "30",
iradiusoverride = "200",
sound_charge = Sound("npc/combine_gunship/gunship_pain.wav"),
sound_explode = Sound("ambient/explosions/explode_7.wav"),
