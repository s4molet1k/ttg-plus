...
local set_players = GetConVarNumber( "ttg_var_players" )
if set_players <= 0 or set_players == nil then
	set_players = 3
end
PLAYERS_PER_TEAM = set_players

local set_tokens = GetConVarNumber( "ttg_var_tokens" )
if set_tokens <= 0 or set_tokens == nil then
	set_tokens = 3
end
