...
local function ReturnToolPurchaseDisplay( swepname, ammo, numguns )
	...
	elseif toolref.class == "gun" then
		...
		elseif numguns == 4 then
			namedisplay = ( "Quadruple " .. convertedname )
		elseif numguns == 5 then
			namedisplay = ( "Quintuple " .. convertedname )
		elseif numguns == 6 then
			namedisplay = ( "Sixtuple " .. convertedname )
		elseif numguns == 7 then
			namedisplay = ( "Septuple " .. convertedname )
		elseif numguns == 8 then
			namedisplay = ( "Octuple " .. convertedname )
		elseif numguns == 9 then
			namedisplay = ( "Nonuple " .. convertedname )
		elseif numguns == 10 then
			namedisplay = ( "Decuple " .. convertedname )
		elseif numguns > 10 then
			namedisplay = ( numguns .. " " .. convertedname .. "s" )
		end
