...
function Menu.Setup()
	...
	local closeButton = Frame.btnClose
	closeButton:SetVisible(true)
	closeButton:SetPos(fw - closeButton:GetWide(), 0)
	
	local minimizeButton = Frame.btnMinim
	minimizeButton:SetVisible(false)
	
	local maximizeButton = Frame.btnMaxim
...
concommand.Add( "gc_pm_selector", Menu.Toggle )
