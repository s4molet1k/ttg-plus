...
,
-- purchase_inviscapsule =
-- {
-- name = "purchase_inviscapsule",
-- print_name = "InvisCapsule",
-- class = "gun",
-- tool_name = "tool_inviscapsule",
...
class = "gun",
tool_name = "tool_chargeshot",
description = "Shoots a laser, that deals 100 damage.\nBefore shooting, you charge it for 2 seconds\nONLY hurts players. \nBuying multiple decreases charge time.",
}
,
}
...
print_name = "Invisibility",
class = "ability",
tool_name = "tool_abil_fastzap",
description = "Makes you invisible for 7 seconds. \nAttacking or taking damage makes you visible.\n20 seconds cooldown.",
}
,
